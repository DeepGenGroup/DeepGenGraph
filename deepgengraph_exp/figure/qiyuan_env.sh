...
# python -m venv deepgengraph_exp_manual_venv
# pip install tensorrt_llm==0.10.0
# pip install click
# source deepgengraph_exp_manual_venv/bin/activate

source /home/zhongrunxin/deepgengraph/deepgengraph_venv/bin/activate
