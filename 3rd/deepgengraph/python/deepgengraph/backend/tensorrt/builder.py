...
from deepgengraph.backend import Builder
from deepgengraph.translate import onnx_from_deepgengraph_kernel
...
class TensorRTBuilder(Builder):
  ...
  def __init__(self, kernel, engine_dir=None, cache_dir=None, check_before_run=False, verbose=False):
    ...
    self.onnx_model = onnx_from_deepgengraph_kernel(self.kernel.module, self.kernel.kernel_name)
