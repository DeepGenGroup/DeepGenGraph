module {
  func.func @RoCo(%arg0: tensor<4096x4096xf16>, %arg1: tensor<4096x4096xf16>, %arg2: tensor<4096x4096xf16>) -> (tensor<4096x4096xf16>, tensor<32x4096xf32>, tensor<32x4096xf32>) {
    ...
    %12 = deepgengraph.reduce %11, dim = 1, op =  ADD : (tensor<32x4096x4096xf32>) -> tensor<32x4096xf32>
    %13 = stablehlo.convert %cst_0 : (tensor<1xi64>) -> tensor<1xf32>
    %14 = deepgengraph.pow %11, %13 : (tensor<32x4096x4096xf32>, tensor<1xf32>) -> tensor<32x4096x4096xf32>
    %15 = deepgengraph.reduce %14, dim = 1, op =  ADD : (tensor<32x4096x4096xf32>) -> tensor<32x4096xf32>
    %16 = stablehlo.convert %11 : (tensor<32x4096x4096xf32>) -> tensor<32x4096x4096xf16>
    %17 = deepgengraph.dot %16, %5, batch_dims = [0] x [0], reduce_dims = [2] x [1] : (tensor<32x4096x4096xf16>, tensor<32x4096x128xf16>) -> tensor<32x4096x128xf16>
