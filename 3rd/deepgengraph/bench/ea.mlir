module {
  func.func @EA(%arg0: tensor<64x784x128xf32>, %arg1: tensor<384x128xf32>, %arg2: tensor<384xf32>, %arg3: tensor<128x128xf32>, %arg4: tensor<128xf32>) -> tensor<64x784x128xf32> {
    ...
    %10 = deepgengraph.softmax %7, dim = 3 : (tensor<64x4x784x32xf32>) -> tensor<64x4x784x32xf32>
    %11 = deepgengraph.softmax %8, dim = 2 : (tensor<64x4x784x32xf32>) -> tensor<64x4x784x32xf32>
    ...
    %14 = deepgengraph.dot %10, %13, batch_dims = [0, 1] x [0, 1], reduce_dims = [3] x [2] : (tensor<64x4x784x32xf32>, tensor<64x4x32x32xf32>) -> tensor<64x4x784x32xf32>
