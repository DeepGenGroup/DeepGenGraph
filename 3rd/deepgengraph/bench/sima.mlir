module {
  func.func @EA(%arg0: tensor<64x784x128xf32>, %arg1: tensor<384x128xf32>, %arg2: tensor<384xf32>, %arg3: tensor<128x128xf32>, %arg4: tensor<128xf32>) -> tensor<64x784x128xf32> {
    ...
    %1 = deepgengraph.dot %arg0, %0, batch_dims = [0] x [], reduce_dims = [2] x [0] : (tensor<64x784x128xf32>, tensor<128x384xf32>) -> tensor<64x784x384xf32>
    %2 = deepgengraph.add %1, %arg2 : (tensor<64x784x384xf32>, tensor<384xf32>) -> tensor<64x784x384xf32>
    %3:3 = deepgengraph.split %2, dim = 2 : (tensor<64x784x384xf32>) -> (tensor<64x784x128xf32>, tensor<64x784x128xf32>, tensor<64x784x128xf32>)
    ...
    %10 = deepgengraph.normalize %7, dim = 2, Lp = 1 : (tensor<64x4x784x32xf32>) -> tensor<64x4x784x32xf32>
    %11 = deepgengraph.normalize %8, dim = 2, Lp = 1 : (tensor<64x4x784x32xf32>) -> tensor<64x4x784x32xf32>
    %12 = stablehlo.transpose %11, dims = [0, 1, 3, 2] : (tensor<64x4x784x32xf32>) -> tensor<64x4x32x784xf32>
    %13 = deepgengraph.dot %12, %9, batch_dims = [0, 1] x [0, 1], reduce_dims = [3] x [2] : (tensor<64x4x32x784xf32>, tensor<64x4x784x32xf32>) -> tensor<64x4x32x32xf32>
    %14 = deepgengraph.dot %7, %13, batch_dims = [0, 1] x [0, 1], reduce_dims = [3] x [2] : (tensor<64x4x784x32xf32>, tensor<64x4x32x32xf32>) -> tensor<64x4x784x32xf32>
    ...
    %18 = deepgengraph.dot %16, %17, batch_dims = [0] x [], reduce_dims = [2] x [0] : (tensor<64x784x128xf32>, tensor<128x128xf32>) -> tensor<64x784x128xf32>
    %19 = deepgengraph.add %18, %arg4 : (tensor<64x784x128xf32>, tensor<128xf32>) -> tensor<64x784x128xf32>
