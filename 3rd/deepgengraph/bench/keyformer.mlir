module {
  func.func @KeyFormer(%arg0: tensor<4096x4096xf16>, %arg1: tensor<4096x4096xf16>, %arg2: tensor<4096x4096xf16>) -> (tensor<4096x4096xf16>, tensor<32x4096xf32>) {
    ...
    %7 = deepgengraph.dot %3, %6, batch_dims = [0] x [0], reduce_dims = [2] x [1] : (tensor<32x4096x128xf16>, tensor<32x128x4096xf16>) -> tensor<32x4096x4096xf16>
    %8 = stablehlo.convert %cst : (tensor<1xf64>) -> tensor<1xf32>
    %9 = stablehlo.convert %7 : (tensor<32x4096x4096xf16>) -> tensor<32x4096x4096xf32>
    %10 = deepgengraph.div %9, %8 : (tensor<32x4096x4096xf32>, tensor<1xf32>) -> tensor<32x4096x4096xf32>
    %11 = deepgengraph.softmax %10, dim = 2 : (tensor<32x4096x4096xf32>) -> tensor<32x4096x4096xf32>
    %12 = deepgengraph.rng distribution =  UNIT_GUMBEL : tensor<32x4096x4096xf32>
    %13 = deepgengraph.add %10, %12 : (tensor<32x4096x4096xf32>, tensor<32x4096x4096xf32>) -> tensor<32x4096x4096xf32>
    %14 = stablehlo.convert %cst_0 : (tensor<1xf64>) -> tensor<1xf32>
    %15 = deepgengraph.div %13, %14 : (tensor<32x4096x4096xf32>, tensor<1xf32>) -> tensor<32x4096x4096xf32>
    %16 = deepgengraph.softmax %15, dim = 2 : (tensor<32x4096x4096xf32>) -> tensor<32x4096x4096xf32>
    %17 = deepgengraph.reduce %16, dim = 1, op =  ADD : (tensor<32x4096x4096xf32>) -> tensor<32x4096xf32>
    %18 = stablehlo.convert %11 : (tensor<32x4096x4096xf32>) -> tensor<32x4096x4096xf16>
    %19 = deepgengraph.dot %18, %5, batch_dims = [0] x [0], reduce_dims = [2] x [1] : (tensor<32x4096x4096xf16>, tensor<32x4096x128xf16>) -> tensor<32x4096x128xf16>
