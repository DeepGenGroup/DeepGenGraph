...
entry:
  %once = call <4 x float> asm sideeffect "v_mmac_f32_16x16x16_f16 $0, $2, $1, $3", "=v,v,v,0"(
  ...
  %twice = call <4 x float> asm sideeffect "v_mmac_f32_16x16x16_f16 $0, $2, $1, $3", "=v,v,v,0"(
      <4 x half> <half 0xH3C00, half 0xH3C00, half 0xH3C00, half 0xH3C00>,
      <4 x half> <half 0xH34CD, half 0xH34CD, half 0xH34CD, half 0xH34CD>,
      <4 x float> %once)
  %seeded = call <4 x float> asm sideeffect "v_mmac_f32_16x16x16_f16 $0, $2, $1, $3", "=v,v,v,0"(
      <4 x half> <half 0xH3C00, half 0xH3C00, half 0xH3C00, half 0xH3C00>,
      <4 x half> <half 0xH34CD, half 0xH34CD, half 0xH34CD, half 0xH34CD>,
