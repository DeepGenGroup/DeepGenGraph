...
void init_deepgengraph_passes(py::module &m) {
  ADD_PASS_WRAPPER_0("add_deepgengraph_simplify", createSimplifyPass);
  ADD_PASS_WRAPPER_0("add_deepgengraph_lower_complex_reduce", createLowerComplexReducePass);
  ADD_PASS_WRAPPER_0("add_deepgengraph_erase_type_in_kernel", createEraseTypeInKernelPass);
  ADD_PASS_WRAPPER_0("add_deepgengraph_replace_exp_and_log", createReplaceExpAndLogPass);
  ADD_PASS_WRAPPER_0("add_deepgengraph_equivalent_transform", createEquivalentTransformPass);
  ADD_PASS_WRAPPER_0("add_deepgengraph_to_mask", createToMaskPass);
  ADD_PASS_WRAPPER_0("add_deepgengraph_annotate_parallelism", createAnnotateParallelismPass);
  ADD_PASS_OPTION_WRAPPER_1("add_deepgengraph_parallelize", createParallelizePass, bool);
  ADD_PASS_WRAPPER_0("add_deepgengraph_tiling", createTilingPass);
  ADD_PASS_WRAPPER_0("add_deepgengraph_dynamic_for", createDynamicForPass);
