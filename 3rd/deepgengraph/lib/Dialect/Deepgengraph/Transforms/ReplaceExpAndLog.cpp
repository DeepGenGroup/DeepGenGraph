...
#define GEN_PASS_DEF_DEEPGENGRAPHREPLACEEXPANDLOG
...
class ReplaceExpAndLogPass : public ::mlir::deepgengraph::impl::DeepgengraphReplaceExpAndLogBase<ReplaceExpAndLogPass> {
public:
