...
#define GEN_PASS_DEF_DEEPGENGRAPHBROADCASTTRANSFORM
...
class BroadcastTransformPass : public ::mlir::deepgengraph::impl::DeepgengraphBroadcastTransformBase<BroadcastTransformPass> {
public:
