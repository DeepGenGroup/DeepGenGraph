...
#define GEN_PASS_DEF_DEEPGENGRAPHERASETYPEINKERNEL
...
class EraseTypeInKernelPass : public ::mlir::deepgengraph::impl::DeepgengraphEraseTypeInKernelBase<EraseTypeInKernelPass> {
public:
