...
#define GEN_PASS_DEF_DEEPGENGRAPHANNOTATEPARALLELISM
...
class AnnotateParallelismPass : public ::mlir::deepgengraph::impl::DeepgengraphAnnotateParallelismBase<AnnotateParallelismPass> {
public:
  using DeepgengraphAnnotateParallelismBase::DeepgengraphAnnotateParallelismBase;
...
std::unique_ptr<mlir::Pass> createAnnotateParallelismPass(const DeepgengraphAnnotateParallelismOptions &options) {
