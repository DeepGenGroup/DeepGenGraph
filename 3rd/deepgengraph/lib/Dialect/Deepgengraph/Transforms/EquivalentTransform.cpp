...
#define GEN_PASS_DEF_DEEPGENGRAPHEQUIVALENTTRANSFORM
...
class EquivalentTransformPass : public ::mlir::deepgengraph::impl::DeepgengraphEquivalentTransformBase<EquivalentTransformPass> {
public:
