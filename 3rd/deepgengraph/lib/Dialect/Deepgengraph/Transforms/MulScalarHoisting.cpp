...
#define GEN_PASS_DEF_DEEPGENGRAPHMULSCALARHOISTING
...
class MulScalarHoistingPass : public ::mlir::deepgengraph::impl::DeepgengraphMulScalarHoistingBase<MulScalarHoistingPass> {
public:
