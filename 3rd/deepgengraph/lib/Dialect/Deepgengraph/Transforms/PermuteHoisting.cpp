...
#define GEN_PASS_DEF_DEEPGENGRAPHPERMUTEHOISTING
...
class PermuteHoistingPass : public ::mlir::deepgengraph::impl::DeepgengraphPermuteHoistingBase<PermuteHoistingPass> {
public:
