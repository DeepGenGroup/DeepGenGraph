...
#define GEN_PASS_DEF_CONVERTDEEPGENGRAPHTODEEPGENGRAPHTRITON
...
class ConvertDeepgengraphToDeepgengraphTriton : public ::mlir::deepgengraph::impl::ConvertDeepgengraphToDeepgengraphTritonBase<ConvertDeepgengraphToDeepgengraphTriton> {
public:
  void runOnOperation() override {
    ...
    // clang-format off
    target.addLegalDialect<::mlir::deepgengraph::DeepgengraphDialect,
...
std::unique_ptr<mlir::Pass> createConvertDeepgengraphToDeepgengraphTritonPass() {
  return std::make_unique<ConvertDeepgengraphToDeepgengraphTriton>();
}
